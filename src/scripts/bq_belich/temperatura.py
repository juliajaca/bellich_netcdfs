...
# %%
n_dataset ='BELICH'
nombre_fichero = 'BELICH_TEMP_SW'

data0 = pd.read_excel('C:/Users/Julia/Documents/VSCODE_BELLICH/src/scripts/bq_belich/Libro2_temp.xlsx',  dtype={  
...
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Hydrodynamics/temperature/BELICH/'
...
value_var.comment = 'sea_water_temperature time series profiles collected at 4 stations identified by geographic coordinates (longitude, latitude).'
...
plt.title('Serie temporal de temperatura en el Mar Menor')
