...
# %%
n_dataset ='BELICH'
nombre_fichero = 'BELICH_PH'

data0 = pd.read_excel('C:/Users/Julia/Documents/VSCODE_BELLICH/src/scripts/bq_belich/Libro3_ph.xlsx',  dtype={  
...
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Biogeochemical/pH/BELICH/'
path_copia = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/Repository/Biogeochemical/pH/'
...
value_var = ncfile.createVariable('pH', np.float32, ('time', 'station_name', 'depth'))
value_var.units = '1'
value_var.standard_name = 'sea_water_ph_reported_on_total_scale'
value_var.long_name = 'Sea water pH (total scale)'
value_var.missing_value = -9999
value_var.grid_mapping = "crs"
value_var.comment = 'sea_water_pH measured time series profiles collected at 4 stations identified by geographic coordinates (longitude, latitude)..'
...
# %%
ruta_destino = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/Repository/Biogeochemical/pH/'
...
plt.xlabel('Fecha')
plt.ylabel('pH')
plt.title('Serie temporal de pH en el Mar Menor')
