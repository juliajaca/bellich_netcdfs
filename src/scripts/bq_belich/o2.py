...
# %%
n_dataset ='BELICH'
nombre_fichero = 'BELICH_OXY'

data0 = pd.read_excel('C:/Users/Julia/Documents/VSCODE_BELLICH/src/scripts/bq_belich/Libro1_oxigeno.xlsx',  dtype={  
...
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Biogeochemical/oxygen/BELICH/'
...
value_var.long_name = 'Mass Concentration of Dissolved Oxygen in Sea Water'
value_var.missing_value = -9999
value_var.grid_mapping = "crs"
value_var.comment = 'Oxygen concentration time series profiles collected at 4 stations identified by geographic coordinates (longitude, latitude).'
...
plt.xlabel('Fecha')
plt.ylabel('Concentración de O2 (mg/L)')
plt.title('Serie temporal de O2 en el Mar Menor')
