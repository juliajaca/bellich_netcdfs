...
# The ncfile object we created is a container for dimensions, variables, and attributes

ncfile = Dataset('mi_archivo2.nc', mode='w', format='NETCDF3_CLASSIC')
print(ncfile)
# %%
...
dates = [dt.datetime(2014,10,1,0),dt.datetime(2014,10,2,0),dt.datetime(2014,10,3,0),]
print(dates)
times = date2num(dates, time.units) #hours since 1800-01-01
time[:] = times
...
# %%
dataset = Dataset('mi_archivo.nc', "r")
print(dataset)
