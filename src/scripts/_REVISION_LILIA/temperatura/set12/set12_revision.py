...
# %% COMPROBACION
dataset = Dataset(f'C:/Users/Julia/Documents/VSCODE_BELLICH/src/scripts/_REVISION_LILIA/temperatura/set12/set12_IEO_EUROGEL/TEMP/set12_TEMP_IEO.nc', "r")
...
#     if not k.startswith('__') and k != 'None' and isinstance(v, np.ndarray)
# }

# # Convertir cada variable a 1D (si es posible) y construir el DataFrame
# df_dict = {}
# for nombre, valor in variables_utiles.items():
#     # Aplanar si es array columna/fila
#     v = valor.squeeze()
#     if v.ndim == 1:
#         df_dict[nombre] = v
#     else:
#         print(f"Variable '{nombre}' ignorada por no ser 1D (shape={v.shape})")
