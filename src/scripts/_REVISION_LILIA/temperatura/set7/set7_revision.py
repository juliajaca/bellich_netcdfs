...
# %% COMPROBACION
dataset = Dataset(f'C:/Users/Julia/Documents/VSCODE_BELLICH/src/scripts/_REVISION_LILIA/temperatura/set7/set7_IEO/set7_TEMP_IEO.nc', "r")
...
# plt.plot(fechas, vars_nc['seawater_temperature'], marker='o')
