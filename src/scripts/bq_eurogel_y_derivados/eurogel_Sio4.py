...
# %%
oxy = data0.loc[(data0['var'] == 'silicato') & (data0['muestreo'] == 'EUROGEL')]
print(data0.head())
...
# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Biogeochemical/nutrients/silicate/EUROGEL/'
path_copia = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/Repository/Biogeochemical/nutrients/nutrients/silicate/'
...
value_var = ncfile.createVariable('silicate', np.float32, ('time', 'station_name', 'depth'))
...
value_var2 = ncfile.createVariable('silicate_at_bottom', np.float32, ('time', 'station_name'))
value_var2.units = 'umol L-1'
value_var2.standard_name = 'mole_concentration_of_silicate_in_sea_water'
value_var2.long_name = 'Dissolved silicate concentration in sea water'
value_var2.missing_value = -9999
value_var2.grid_mapping = "crs"
value_var2.comment = 'Silicate at bottom of the station'
...
unit2 = dataset.variables['silicate_at_bottom'][:]
unit = dataset.variables['silicate'][:]
