...
# %%
n_dataset ='EUROGEL'
nombre_fichero = 'EUROGEL_OXY_SAT'
...
# %%
oxy = data0.loc[(data0['var'] == 'O2 sat') & (data0['muestreo'] == 'EUROGEL')]
print(data0.head())
...
# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Biogeochemical/oxygen/EUROGEL/'
...
unit2 = dataset.variables['oxygen_saturation_at_bottom'][:]
unit = dataset.variables['oxygen_saturation'][:]
...
# %%
ruta_destino = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/Repository/Biogeochemical/oxygen/'
