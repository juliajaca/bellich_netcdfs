...
# %%
oxy = data0.loc[(data0['var'] == 'fosfato') & (data0['muestreo'] == 'EUROGEL')]
print(data0.head())
...
depths_enteros =  [0,1,2,3,4,5] #no hace falta poner el 6 porque solo lo tiene E13 y es su bottom
depths_bottom = np.sort(depths[~mask_enteros])

# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Biogeochemical/nutrients/phosphate/EUROGEL/'
path_copia = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/Repository/Biogeochemical/nutrients/nutrients/phosphate/'
...
unit2 = dataset.variables['phosphate_at_bottom'][:]
unit = dataset.variables['phosphate'][:]
