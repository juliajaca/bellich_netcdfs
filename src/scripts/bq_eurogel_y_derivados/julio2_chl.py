...
nombre_fichero = 'IEO_COMU_2_CHL' #TESIS DE Juli
...
# %%
oxy = data0.loc[(data0['var'] == 'chl') & (data0['Referencia'] == 'Excel JM86')]
print(data0.head())
...
value_var = ncfile.createVariable('chlorophyll', np.float32, ('time', 'station_name','level'))
...
for i_station, station in enumerate(stations):
    ...
    plt.title(f'Serie temporal de chlorophyll en {station} en {northing[i_station]} y {easting[i_station]}')
