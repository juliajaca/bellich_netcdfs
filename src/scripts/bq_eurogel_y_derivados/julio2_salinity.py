...
nombre_fichero = 'IEO_COMU_2_SAL' #TESIS DE Juli
...
# %%
oxy = data0.loc[(data0['var'] == 'sal') & (data0['Referencia'] == 'Excel JM86')]
print(data0.head())
...
# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Hydrodynamics/salinity/IEO_COMU_2/'
...
value_var = ncfile.createVariable('seawater_salinity', np.float32, ('time', 'station_name','level'))
value_var.units = '1'
