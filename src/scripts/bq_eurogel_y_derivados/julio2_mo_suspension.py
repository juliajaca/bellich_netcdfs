...
nombre_fichero = 'IEO_COMU_2_SPM' #TESIS DE Juli
...
# %%
oxy = data0.loc[(data0['var'] == 'materia suspension (mg/l)') & (data0['Referencia'] == 'Excel JM86')]
print(data0.head())
...
# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Biogeochemical/SPM/IEO_COMU_2/'
path_copia = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/Repository/Biogeochemical/SPM/'
...
value_var = ncfile.createVariable('suspended_particulate_matter', np.float32, ('time', 'station_name','level'))
value_var.units = 'mg L-1'
value_var.standard_name = 'mass_concentration_of_suspended_matter_in_sea_water'
value_var.long_name= 'Suspended Particulate Matter concentration'
...
unit = dataset.variables['suspended_particulate_matter'][:]
...
for i_station, station in enumerate(stations):
    ...
    plt.xlabel('Fecha')
    plt.ylabel('SPM')
    plt.title(f'Serie temporal de SPM en {station} en {northing[i_station]} y {easting[i_station]}')
