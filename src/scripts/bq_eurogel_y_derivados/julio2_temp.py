...
nombre_fichero = 'IEO_COMU_2_TEMP_SW' #TESIS DE Juli
...
# %%
oxy = data0.loc[(data0['var'] == 'temp') & (data0['Referencia'] == 'Excel JM86')]
print(data0.head())
...
value_var = ncfile.createVariable('seawater_temperature', np.float32, ('time', 'station_name','level'))
