...
# %%
oxy = data0.loc[(data0['var'] == 'O2 conc') & (data0['muestreo'] == 'EUROGEL')]
print(data0.head())
...
value_var2 = ncfile.createVariable('oxygen_at_bottom', np.float32, ('time', 'station_name'))
...
value_var2.comment = 'oxygen at bottom of the station'
...
unit2 = dataset.variables['oxygen_at_bottom'][:]
