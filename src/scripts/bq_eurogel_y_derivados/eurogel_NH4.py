...
# %%
oxy = data0.loc[(data0['var'] == 'amonio') & (data0['muestreo'] == 'EUROGEL')]
print(data0.head())
...
# depths_enteros = np.sort(depths[mask_enteros]) #el 6 no hace falta que solo lo tiene E13
depths_enteros = [0,1,2,3,4,5]
depths_bottom = np.sort(depths[~mask_enteros])

# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Biogeochemical/nutrients/ammonium/EUROGEL/'
path_copia = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/Repository/Biogeochemical/nutrients/ammonium/'
...
ncfile.comment = 'Coordinates for RAMBLA station are approximate.'
...
unit2 = dataset.variables['ammonium_at_bottom'][:]
unit = dataset.variables['ammonium'][:]
