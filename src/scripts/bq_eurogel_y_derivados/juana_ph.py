...
nombre_fichero = 'IEO_COMU_2_PH' #TESIS DE JUANA CANO
...
# %%
oxy = data0.loc[(data0['var'] == 'ph') & (data0['muestreo'] == 'Juana Cano')]
print(data0.head())
...
# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Biogeochemical/pH/IEO_COMU_2/'
