...
nombre_fichero = 'IEO_COMU_3_PH' #TESIS DE JUANA CANO
...
# %%
oxy = data0.loc[(data0['var'] == 'ph') &  (data0['Referencia'] == 'Excel JC88-92') & (data0['muestreo'] == 'Juana Cano')]
...
# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Biogeochemical/pH/IEO_COMU_3/'
...
for i_station, station in enumerate(stations):
    ...
    plt.xlabel('Fecha')
    plt.ylabel('pH ')
    plt.title(f'Serie temporal de pH en {station} en {northing[i_station]} y {easting[i_station]}')
