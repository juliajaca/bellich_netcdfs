...
nombre_fichero = 'IEO_COMU_2_KD' #TESIS DE Juli
...
# %%
oxy = data0.loc[(data0['var'] == 'kd') & (data0['Referencia'] == 'Excel JM86')]
print(data0.head())
...
# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Biogeochemical/diffuse_attenuation_coefficient/IEO_COMU_2/'
path_copia = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/Repository/Biogeochemical/diffuse_attenuation_coefficient/'
...
lat_var[:] =  [ 37.783333, 37.7, 37.666667, ]
...
value_var = ncfile.createVariable('diffuse_attenuation_coefficient', np.float32, ('time', 'station_name','level'))
value_var.units = 'm-1'
value_var.standard_name = 'Diffuse_attenuation_coefficient_for_downwelling_PAR'
value_var.long_name= 'Kd (Diffuse attenuation coefficient)'
...
unit = dataset.variables['diffuse_attenuation_coefficient'][:]
...
for i_station, station in enumerate(stations):
    ...
    plt.xlabel('Fecha')
    plt.ylabel('diffuse_attenuation_coefficient')
    plt.title(f'Serie temporal de kd en {station} en {northing[i_station]} y {easting[i_station]}\n REVISAR PORQUE LAS TRES PROFS TIENEN EL MISMO KD')
