...
# %%
oxy = data0.loc[(data0['var'] == 'nitrito') & (data0['muestreo'] == 'EUROGEL')]
print(data0.head())
...
# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Biogeochemical/nutrients/nitrite/EUROGEL/'
path_copia = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/Repository/Biogeochemical/nutrients/nutrients/nitrite/'
...
unit2 = dataset.variables['nitrite_at_bottom'][:]
unit = dataset.variables['nitrite'][:]
