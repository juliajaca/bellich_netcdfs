...
nombre_fichero = 'IEO_COMU_1_TEMP_SW' #TESIS DE Juli
...
# %%
oxy = data0.loc[(data0['var'] == 'temp') & (data0['Referencia'] == 'Excel ARG8182')]
print(data0.head())
...
# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Hydrodynamics/temperature/IEO_COMU_1/'
...
for i_station, station in enumerate(stations):
    ...
    plt.xlabel('Fecha')
    plt.ylabel('T ºC')
    plt.title(f'Serie temporal de temp en {station} en {northing[i_station]} y {easting[i_station]}')
...
def calcular_area_rectangulo(p1, p2, p3, p4):
    # Agrupamos los puntos en una lista
    puntos = [p1, p2, p3, p4]
...
# Ejemplo de uso:
# Puntos de un rectángulo: (0,0), (4,0), (4,3), (0,3)
pt1 = (0, 0)
pt2 = (4, 0)
pt3 = (4, 3)
pt4 = (0, 3)

area = calcular_area_rectangulo(pt1, pt2, pt3, pt4)
