...
# %%
oxy = data0.loc[(data0['var'] == 'temp') & (data0['muestreo'] == 'EUROGEL')]
print(data0.head())
...
# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Hydrodynamics/temperature/EUROGEL/'
...
value_var2 = ncfile.createVariable('seawater_temperature_at_bottom', np.float32, ('time', 'station_name'))
value_var2.units = 'degree_Celsius'
value_var2.standard_name = 'sea_water_temperature'
value_var2.long_name = 'Sea water temperature'
value_var2.missing_value = -9999
value_var2.grid_mapping = "crs"
value_var2.comment = 'Sea water temperature at bottom of the station'
...
unit2 = dataset.variables['seawater_temperature_at_bottom'][:]
...
# %%
ruta_destino = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/Repository/Hydrodynamics/temperature/'
