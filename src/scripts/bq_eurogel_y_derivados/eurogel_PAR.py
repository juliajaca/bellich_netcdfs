...
# %%
oxy = data0.loc[(data0['var'] == 'PAR') & (data0['muestreo'] == 'EUROGEL')]
print(data0.head())
...
depths_enteros = [0,1,2,3,4,5,6]
depths_bottom = np.sort(depths[~mask_enteros])

# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Biogeochemical/PAR/EUROGEL/'
...
value_var = ncfile.createVariable('PAR', np.float32, ('time', 'station_name', 'depth'))
value_var.units = 'µmol m-2 s-1'
value_var.standard_name = 'downwelling_photosynthetic_photon_flux_in_sea_water'
value_var.long_name = 'Photosynthetically Active Radiation (PAR)'
value_var.missing_value = -9999
value_var.grid_mapping = "crs"
value_var.comment = ''

value_var2 = ncfile.createVariable('PAR_at_bottom', np.float32, ('time', 'station_name'))
value_var2.units = 'µmol m-2 s-1'
value_var2.standard_name = 'downwelling_photosynthetic_photon_flux_in_sea_water'
value_var2.long_name = 'Photosynthetically Active Radiation (PAR)'
value_var2.missing_value = -9999
value_var2.grid_mapping = "crs"
value_var2.comment = 'Photosynthetically Active Radiation (PAR) at bottom of the station'
...
bottom_depth_var[:] =[1.4, 5.1, 5.3, 5.3, 5.5, 6.2, 4.8, 5.1, 5.9, 6.1, 3.7, 5.3,6, 5, 3.5,  3.2, 5.7, 4.6, 4, 5.5, 5.5, 4.2, 5.3, 5.3,  ] # array de 24 valores, uno por estación
...
unit2 = dataset.variables['PAR_at_bottom'][:]
unit = dataset.variables['PAR'][:]
...
ruta_destino = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/Repository/Biogeochemical/PAR/'
