...
depths = turb.profundidad.unique()
...
# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Biogeochemical/turbidity/EUROGEL/'
path_copia = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/Repository/Biogeochemical/turbidity/'

data = turb.sort_values(by=["fecha", "estacion", 'profundidad']).reset_index(drop=True)
...
lat_var[:] =  [37.8, 37.7833, 37.76667, 37.76667, 37.75, 37.75, 37.75, 
          37.73333 ,37.73333, 37.73333  , 37.71667 , 37.71667 , 37.71667 ,
            37.71667,37.7, 37.7,  37.7, 37.7, 37.68333, 37.68333, 
             37.68333, 37.66667,  37.66667, 37.65]
...
value_var = ncfile.createVariable('turbidity', np.float32, ('time', 'station_name', 'depth'))
value_var.units = 'NTU'
value_var.standard_name = 'sea_water_turbidity'
value_var.long_name = 'turbidity'
value_var.missing_value = -9999
value_var.grid_mapping = "crs"
value_var.comment = ''

value_var2 = ncfile.createVariable('turbidity_at_bottom', np.float32, ('time', 'station_name'))
value_var2.units = 'NTU'
value_var2.standard_name = 'sea_water_turbidity'
value_var2.long_name = 'turbidity'
value_var2.missing_value = -9999
value_var2.grid_mapping = "crs"
value_var2.comment = 'turbidity at bottom of the station'
...
# Ahora sí podemos ordenar # esto cambia el orden
# data_fondo = data_fondo.sort_values(by=["fecha", "profundidad", "estacion"]).reset_index(drop=True)
# pivot = data_fondo.pivot_table(index='fecha',  columns=['profundidad', 'estacion'], values='valor')
# value_var2[:,:] = pivot
data_fondo = data.loc[data_fondo_mask]
data_fondo = data_fondo.sort_values(by=["fecha", "profundidad", "estacion"]).reset_index(drop=True)
...
bottom_depth_var[:] = [1.4, 5.1, 5.3, 5.3, 5.5, 6.2, 4.8, 5.1, 5.9, 6.1, 3.7, 5.3, 6,5, 3.5, 
                       3.2, 5.7, 4.6, 4, 5.5, 5.5, 4.2, 5.3, 5.3]  # array de 24 valores, uno por estación
...
unit2 = dataset.variables['turbidity_at_bottom'][:]
unit = dataset.variables['turbidity'][:]
...
# %%
ruta_destino = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/Repository/Biogeochemical/turbidity/'
