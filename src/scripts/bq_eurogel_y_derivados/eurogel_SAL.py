...
# %%
oxy = data0.loc[(data0['var'] == 'sal') & (data0['muestreo'] == 'EUROGEL')]
print(data0.head())
...
# %%
path = 'C:/Users/Julia/Nextcloud/Datos_MM_Art_2025/datasets_ncFormat/Hydrodynamics/salinity/EUROGEL/'
...
value_var2 = ncfile.createVariable('seawater_salinity_at_bottom', np.float32, ('time', 'station_name'))
value_var2.units = '1'
value_var2.standard_name = 'sea_water_practical_salinity'
value_var2.long_name = 'Practical salinity of sea water'
value_var2.missing_value = -9999
value_var2.grid_mapping = "crs"
value_var2.comment = 'Practical salinity of sea water at bottom of the station'
...
unit2 = dataset.variables['seawater_salinity_at_bottom'][:]
